...
predictor = Predictor(os.path.join(base_path, 'carbot_data/model/kbqasp'))


examples = predictor.processor.get_dev_examples(os.path.join(base_path, 'data/train/kbqa/complex_qa/'))
data_df = []
...
writer = pd.ExcelWriter(os.path.join(base_path, 'report/kbqasp.xlsx'))
