...
| tag  | 识别出的正确实体数 | 识别出的实体数 | 样本的实体数 | precision | recall | f1   |
| ---- | ------------------ | -------------- | ------------ | --------- | ------ | ---- |
| 汽车 | 46                 | 60             | 54           | 76.67     | 85.19  | 80.7 |

​	详细实验结果见附件 report/ner.xlsx。
...
| label              | 数量 | precision | recall | f1    |
| ------------------ | ---- | --------- | ------ | ----- |
| 上市时间           | 26   | 100       | 100    | 100   |
| 中央差速器结构     | 2    | 66.67     | 100    | 80    |
| 供油方式           | 1    | 100       | 100    | 100   |
| 前制动器类型       | 1    | 0         | 0      | 0     |
| 前悬架类型         | 2    | 66.67     | 100    | 80    |
| 前电动机最大功率   | 1    | 25        | 100    | 40    |
| 前轮胎规格         | 6    | 75        | 100    | 85.71 |
| 前轮距             | 1    | 0         | 0      | 0     |
| 助力类型           | 2    | 66.67     | 100    | 80    |
| 厂商指导价         | 15   | 88.24     | 100    | 93.75 |
| 压缩比             | 5    | 100       | 100    | 100   |
| 发动机             | 1    | 100       | 100    | 100   |
| 发动机型号         | 2    | 100       | 100    | 100   |
| 变速箱类型         | 6    | 100       | 100    | 100   |
| 后制动器类型       | 1    | 0         | 0      | 0     |
| 后悬架类型         | 1    | 0         | 0      | 0     |
| 后电动机最大扭矩   | 10   | 75        | 60     | 66.67 |
| 后轮胎规格         | 2    | 100       | 100    | 100   |
| 后轮距             | 1    | 100       | 100    | 100   |
| 四驱形式           | 3    | 75        | 100    | 85.71 |
| 备胎规格           | 4    | 100       | 100    | 100   |
| 官方0-100km/h加速  | 2    | 100       | 50     | 66.67 |
| 实测0-100km/h加速  | 3    | 50        | 66.67  | 57.14 |
| 实测油耗           | 4    | 75        | 75     | 75    |
| 实测续航里程       | 3    | 100       | 33.33  | 50    |
| 工信部纯电续驶里程 | 1    | 0         | 0      | 0     |
| 工信部综合油耗     | 24   | 76        | 79.17  | 77.55 |
| 座位数             | 5    | 100       | 100    | 100   |
| 快充时间           | 1    | 0         | 0      | 0     |
| 快充电量           | 1    | 50        | 100    | 66.67 |
| 排量               | 7    | 87.5      | 100    | 93.33 |
| 整备质量           | 10   | 100       | 90     | 94.74 |
| 整车质保           | 1    | 100       | 100    | 100   |
| 最大功率           | 1    | 0         | 0      | 0     |
| 最大载重质量       | 1    | 0         | 0      | 0     |
| 最大马力           | 4    | 80        | 100    | 88.89 |
| 最小离地间隙       | 9    | 100       | 100    | 100   |
| 最高车速           | 8    | 88.89     | 100    | 94.12 |
| 每缸气门数         | 1    | 0         | 0      | 0     |
| 气缸排列形式       | 2    | 100       | 100    | 100   |
| 气缸数             | 7    | 87.5      | 100    | 93.33 |
| 油箱容积           | 13   | 81.25     | 100    | 89.66 |
| 燃油标号           | 4    | 100       | 100    | 100   |
| 环保标准           | 15   | 100       | 93.33  | 96.55 |
| 电动机总功率       | 1    | 0         | 0      | 0     |
| 电动机总扭矩       | 1    | 100       | 100    | 100   |
| 电池类型           | 1    | 100       | 100    | 100   |
| 电池组质保         | 2    | 66.67     | 100    | 80    |
| 百公里耗电量       | 2    | 100       | 50     | 66.67 |
| 系统综合功率       | 1    | 0         | 0      | 0     |
| 级别               | 8    | 100       | 100    | 100   |
| 缸体材料           | 1    | 0         | 0      | 0     |
| 缸径               | 1    | 100       | 100    | 100   |
| 缸盖材料           | 2    | 66.67     | 100    | 80    |
| 能源类型           | 1    | 0         | 0      | 0     |
| 行李厢容积         | 2    | 100       | 50     | 66.67 |
| 轴距               | 1    | 0         | 0      | 0     |
| 进气形式           | 1    | 100       | 100    | 100   |
| 长*宽*高           | 11   | 91.67     | 100    | 95.65 |
| 长度               | 4    | 100       | 100    | 100   |
| 驱动方式           | 10   | 90        | 90     | 90    |
| 高度               | 1    | 0         | 0      | 0     |
| total              | 271  | 87.45     | 87.45  | 87.45 |

​	详细实验结果见附件 report/kbqapc.xlsx。
...
| 是否匹配 | 数量  | precision | recall | f1    |
| -------- | ----- | --------- | ------ | ----- |
| No       | 19736 | 98.34     | 99.16  | 98.75 |
| Yes      | 9870  | 98.29     | 96.65  | 97.46 |
| total    | 29606 | 98.32     | 98.32  | 98.32 |

​	详细实验结果见附件 report/kbqapm.xlsx。
...
| 是否匹配 | 数量 | precision | recall | f1    |
| -------- | ---- | --------- | ------ | ----- |
| No       | 1839 | 99.51     | 99.95  | 99.73 |
| Yes      | 170  | 99.38     | 94.71  | 96.99 |
| total    | 2009 | 99.5      | 99.5   | 99.5  |

​	详细实验结果见附件 report/kbqasp.xlsx。
