...
from pytorch_pretrained_bert.modeling import BertForTokenClassification, BertConfig
...
def main():
    ...
    if args.do_train and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        processor.save(os.path.join(args.output_dir, sequence_labeling.PROCESSOR_NAME))
