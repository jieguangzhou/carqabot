...
def main():
    ...
    labels = ['上市时间', '中央差速器结构', '供油方式',
              ...
              '压缩比', '发动机', '发动机型号', '变速箱类型',
              '后制动器类型', '后悬架类型', '后电动机最大扭矩',
              '后轮胎规格', '后轮距', '四驱形式', '备胎规格',
              '官方0-100km/h加速', '实测0-100km/h加速', '实测油耗',
              '实测续航里程', '工信部纯电续驶里程', '工信部综合油耗',
              '座位数', '快充时间', '快充电量', '排量', '整备质量',
              '整车质保', '最大功率', '最大载重质量', '最大马力',
              '最小离地间隙', '最高车速', '每缸气门数', '气缸排列形式',
              '气缸数', '油箱容积', '燃油标号', '环保标准',
              '电动机总功率', '电动机总扭矩', '电池类型', '电池组质保',
              '百公里耗电量', '系统综合功率', '级别', '缸体材料',
              '缸径', '缸盖材料', '能源类型', '行李厢容积',
              '轴距', '进气形式', '长*宽*高', '长度',
              '驱动方式', '高度']
    ...
    if args.do_train and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        processor.save(os.path.join(args.output_dir, text_classification.PROCESSOR_NAME))
